function Get-GoogleAuthenticatorPin   ## Self explanatory
{
    [CmdletBinding()]
    Param
    (
    ...
    $epochTime = ([DateTime]::Now.ToUniversalTime().Ticks - 621355968000000000) / 10000000
    ...
    $hmacGen = [Security.Cryptography.HMACSHA256]::new($secretAsBytes)
